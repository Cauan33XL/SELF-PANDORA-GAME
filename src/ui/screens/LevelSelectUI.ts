...
export class LevelSelectUI extends BaseUIComponent {
  ...
  constructor(
    ...
    super('level-screen', 'screen pointer-events-none flex flex-col justify-start items-center w-full h-full p-10 transition-all duration-700');
