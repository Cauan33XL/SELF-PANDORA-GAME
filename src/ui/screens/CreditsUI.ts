...
export class CreditsUI extends BaseUIComponent {
  private onClose: () => void;

  constructor(onClose: () => void) {
    super('credits-screen', 'screen pointer-events-none flex flex-col justify-center items-center w-full h-full p-10 transition-all duration-700');
