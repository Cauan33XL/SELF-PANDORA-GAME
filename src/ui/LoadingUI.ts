export class LoadingUI {
  ...
  constructor() {
    ...
    this.container.className = 'screen active pointer-events-auto flex flex-col justify-center items-center w-full h-full transition-all duration-1000 bg-[#0c0c0e]/95 z-50';
