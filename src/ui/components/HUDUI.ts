    ...
    this.container.innerHTML = `
      ...
      <div class="flex justify-between items-start w-full pointer-events-none">
        ...
        <div class="hud-right flex flex-col items-end pointer-events-auto">
          <button class="flex items-center justify-center w-11 h-11 rounded-full border border-white/15 bg-black/40 hover:bg-white/10 hover:border-white/40 hover:shadow-[0_0_20px_rgba(255,255,255,0.2)] backdrop-blur-md transition-all duration-500 group">
            <svg class="w-5 h-5 text-zinc-300 group-hover:text-white group-hover:rotate-90 transition-all duration-700 ease-out" fill="none" stroke="currentColor" viewBox="0 0 24 24">
